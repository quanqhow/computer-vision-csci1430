...
% 3 works all right for mt rushmore
% runs on 241 matches
...
% pic_a = imresize(pic_a, 0.75, 'bilinear');
% pic_b = imresize(pic_b, 0.75, 'bilinear');
% 3 works all right
% runs on 510 matches
...
% SIFT matching parameter of 4.5 works well
% Run on 43 matches
...
% 3.5 works all right, Runs on 46 matches
